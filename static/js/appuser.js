    ...
    const addDataToHTML = () => {
        ...
        if (products.length > 0) {
            products.forEach(product => {
                ...
                <a href="/editmaterialuser/${product.Materials_ID}">
                    <button class="primary">เเก้ไขข้อมูล</button>
                </a><br>
                <a href="/deletematerialuser/${product.Materials_ID}" onclick="return confirm('Are you sure you want to delete this item?');">
